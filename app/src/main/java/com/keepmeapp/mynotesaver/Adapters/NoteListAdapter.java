package com.keepmeapp.mynotesaver.Adapters;
...
//import com.netsoftnotepad.mynotesaver.R;
...
public class NoteListAdapter extends RecyclerView.Adapter<NoteViewHolder>{
    Context context;
    List<Notes> list;
    com.keepmeapp.mynotesaver.NotesClickListener listener;

    public NoteListAdapter(Context context, List<Notes> list, com.keepmeapp.mynotesaver.NotesClickListener listener) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            holder.notes_container.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    listener.onLongClicked(list.get(holder.getAdapterPosition()), holder.notes_container);
                    return true;
                }
            });
        }
    ...
    public NoteViewHolder(@NonNull View itemView) {
        ...
        txt_notes = itemView.findViewById(R.id.txtnotes);
        txt_date = itemView.findViewById(R.id.txtdate);
        img_pin = itemView.findViewById(R.id.imgpin);
    }
}